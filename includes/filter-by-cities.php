    ...
    if ( ! class_exists( 'Filters_By_Cities_Method' ) ) {
        ...
        class Filters_By_Cities_Method extends WC_Shipping_Method
        {
            ...
            public function __construct($instance_id = 0)
            {
                ...
                $this->method_title       = __( 'Shipping filter By Cities', 'departamentos-y-ciudades-de-peru-para-woocommerce' );
                $this->method_description = __( 'Allows adding rules by city', 'departamentos-y-ciudades-de-peru-para-woocommerce' );
