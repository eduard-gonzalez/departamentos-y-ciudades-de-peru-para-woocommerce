...
$settings =  array(
    'single_method' => array(
        'title' 		=> __( 'Single method', 'departamentos-y-ciudades-de-peru-para-woocommerce' ),
        'type' 			=> 'select',
        'description' 	=> __( 'When doing single shipping method, it eliminates all others and imposes its own rules', 'departamentos-y-ciudades-de-peru-para-woocommerce' ),
    ...
    'cost' => array(
        'title' => __('Coste', 'departamentos-y-ciudades-de-peru-para-woocommerce'),
        'type' 			=> 'text',
    ...
    'cities' => array(
        'title' => __('Cities','departamentos-y-ciudades-de-peru-para-woocommerce'),
        'type' => 'multiselect',
        'class'       => 'wc-enhanced-select',
        'description' => __( 'Select the city referring to the region that you have previously added', 'departamentos-y-ciudades-de-peru-para-woocommerce' ),
